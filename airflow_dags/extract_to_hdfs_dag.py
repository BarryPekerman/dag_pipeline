...
def upload_to_hdfs_py():
    ...
    print(">>> Entering upload_to_hdfs_py()")
    ...
    try:
        ...
        print(">>> Upload to HDFS completed.")

    except Exception:
        print(">>> ERROR during upload_to_hdfs_py():")
